        ...
        <div class="container"  >
            <div class="row" >
                ...
                <div class="col-12" align="center">  
                    <div class="cuadro" >
                        <h2>REGISTRO DE PADRES/MADRES <i class="fa-solid fa-file-lines"></i></h2><br>
                        <form action="ServletRegistroC">
                            <table class="table">
                                ...
                                <div class="sticky-sm-bottom">
                                    ...
                                    <tr>
                                        <td><i class="fa-solid fa-person-breastfeeding"></i> Encargado de la cuenta (Solo uno): </td>
                                        <td><input type="text" name="txtFuncion" class="form-control" placeholder="Padre/Madre" required></td>
                                    </tr>
