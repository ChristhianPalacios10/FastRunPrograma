...
<%
        ...
        datos = (Conductor) sesionFR.getAttribute("datos");
    }
%>
<!DOCTYPE html>
<html>
                ...
                <div class="row">
                    <div class="col-6" >
                        <div class="cuadro">
                            ...
                            <div>
                                <h3>Conductor:</h3>
                                <h4><%=datos.getNombres()%> <%=datos.getApellidos()%></h4>
                                <h3>Edad:</h3>
                                <h4><%=datos.getEdad()%></h4>
                                <h3> Correo:</h3>
                                <h4><%=datos.getCorreo()%></h4>
                                <h3> Celular:</h3>
                                <h4><%=datos.getTelefono()%></h4>
                                <h3> DNI:</h3>
                                <h4><%=datos.getDni()%></h4>
                    ...
                    <div class="col-6"> 
                        <div class="cuadro" >
                            <div >
                                ...
                                <h4> Modelo de Vehiculo: <%=datos.getModelo()%></h4>
                                <h4> Número de Placa: <%=datos.getPlaca()%></h4>
                                <h4>Dirección: <%=datos.getDireccion()%></h4>
                                <h4> Brevete: <%=datos.getBrevete()%></h4>
                                <h4> Nacionalidad: <%=datos.getNacionalidad()%></h4>
