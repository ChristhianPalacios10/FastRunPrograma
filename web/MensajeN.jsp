            ...
            <div class="container">
                <div class="cuadro col-12">
                    <div class="row ">
                        <div class="col-6">
                            <div class="imagen">
                                <img src="imagenes/confirmacion1.jpg">
                            </div>
                        </div>
                        <div class="col-6">
                            <h3 class="titulo ">
                                <p>TU SOLICITUD FUE REGISTRADO <i class="fa-solid fa-circle-check"></i>
                                </p>
                            </h3>
                            
                            <br>
                            <br>
                            <a class="btn btn-info" href="Solicitudes.jsp" role="button"><i class="fa-solid fa-arrow-left"></i> SEGUIR SOLICITANDO MOVILIDAD</a>
